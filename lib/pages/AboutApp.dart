...
class AboutApp extends GetView<MyController> {
  ...
  void sendd()async {
    final Uri params = Uri(
      ...
      query: 'subject=app تطبيق البر والصلة والادابFeedback&body=App Version 1', //add subject and body here
    );
...
<p>bootoader:${androidInfo.bootloader}</p>
             ...
             /*   Divider(height: 0,thickness: 1,),
                ...
                ListTile(
                  onTap: (){
                    controller.share(
                        "تطبيق البر والصلة والاداب","مشاركة التطبيق ","https://play.google.com/store/apps/details?id=apps.soonfu.pro"
                    );
                  },
